...
public abstract class Particle extends Thread {
    ...
    public static void loadParticles() throws Exception {
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_SLASH1].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_SLASH1][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/slash1/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_SLASH2].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_SLASH2][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/slash2/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_SLASH3].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_SLASH3][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/slash3/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_DRIVE].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_DRIVE][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/drive/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_VORPAL].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_VORPAL][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/vorpal/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_MULTI].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_MULTI][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/multi/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_CINDER].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_CINDER][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/cinder/" + i + ".png"));
        }
        PARTICLE_SPRITE[Globals.PARTICLE_BURN] = new BufferedImage[20];
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BURN].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BURN][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/burn/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_TAUNT].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_TAUNT][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/taunt/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_TAUNTAURA1].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_TAUNTAURA1][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/tauntaura/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_TAUNTAURA2].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_TAUNTAURA2][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/tauntaura2/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_ARC].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_ARC][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/arc/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_RAPID].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_RAPID][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/rapid/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_POWER].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_POWER][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/power/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_POWERPARTICLE].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_POWERPARTICLE][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/power2/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_POWERCHARGE].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_POWERCHARGE][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/powercharge/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_VOLLEYBOW].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_VOLLEYBOW][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/volleybow/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_VOLLEYARROW].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_VOLLEYARROW][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/volleyarrow/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_STORM].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_STORM][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/stormarrow/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_FROSTARROW].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_FROSTARROW][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/frostarrow/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_DASH].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_DASH][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/dash/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_FORTIFY].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_FORTIFY][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/fortify/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_FORTIFYBUFF].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_FORTIFYBUFF][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/fortifybuff/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_CHARGE].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_CHARGE][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/charge/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_CHARGEPARTICLE].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_CHARGEPARTICLE][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/charge2/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_REFLECTCAST].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_REFLECTCAST][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/reflectcast/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_REFLECTBUFF].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_REFLECTBUFF][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/reflectbuff/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_REFLECTHIT].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_REFLECTHIT][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/reflecthit/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_IRON].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_IRON][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/ironfort/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_IRONALLY].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_IRONALLY][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/ironfortally/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_TOSS].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_TOSS][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/toss/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SWORD_SLASHBUFF].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SWORD_SLASHBUFF][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/slashbuff/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_DASHBUFF].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_SHIELD_DASHBUFF][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/dashbuff/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_BOW_VOLLEYBUFF].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_BOW_VOLLEYBUFF][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/volleybuff/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_PASSIVE_RESIST].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_PASSIVE_RESIST][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/resist/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_PASSIVE_BARRIER].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_PASSIVE_BARRIER][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/barrier/" + i + ".png"));
        }
        ...
        for (int i = 0; i < PARTICLE_SPRITE[Globals.PARTICLE_PASSIVE_SHADOWATTACK].length; i++) {
            PARTICLE_SPRITE[Globals.PARTICLE_PASSIVE_SHADOWATTACK][i] = ImageIO.read(Globals.class.getResourceAsStream("sprites/particle/shadowattack/" + i + ".png"));
        }
    }
