...
//  PRIVATE STATIC VARIABLES
    ...
    /**
     * Maximum number of normal (non-streaming) channels that can be created. NOTE: JavaSound may require the total number of channels (non-streaming + streaming) to be 32.
     */
    private static int numberNormalChannels = 28;
    /**
     * Maximum number of streaming channels that can be created. NOTE: JavaSound may require the total number of channels (non-streaming + streaming) to be 32.
     */
    ...
    /**
     * Number of buffers used for each streaming sorce. Slow codecs may require this number to be greater than 2 to prevent audio skipping during playback.
     */
    ...
    /**
     * Size of each chunk to read at a time for loading (non-streaming) files. Increase if loading sound files is causing significant lag.
     */
...
//  PRIVATE INTERNAL METHODS
    ...
    /**
     * Returns the results of calling the specified method from the specified class using the specified parameters.
     *
...
//  PRIVATE INTERNAL CLASSES
    /**
     * The Codec class is used to associate individual file formats with the codecs used to load audio data from them.
     *
     * Author: Paul Lamb
     */
    private static class Codec {
        ...
        /**
         * A regular expression used to match a file's extension. This is used to determine the file format.
         */
        ...
        /**
         * Constructor: Converts the specified extension string into a regular expression, and associates that with the specified codec.
         *
         * @param extension File extension to be associated with the specified codec.
