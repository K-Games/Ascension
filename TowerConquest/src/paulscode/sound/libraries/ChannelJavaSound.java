...
/**
 * The ChannelJavaSound class is used to reserve a sound-card voice using JavaSound. Channels can be either normal or streaming channels.
 *
...
public class ChannelJavaSound extends Channel {
    ...
    /**
     * The paulscode.sound.LibraryJavaSound.SoundBuffer containing the sound data to play for a normal source.
     */
    ...
    /**
     * List of paulscode.sound.LibraryJavaSound.SoundBuffer, used to queue chunks of sound data to be streamed.
     */
    ...
    /**
     * Plays the next queued byte[] buffer. This method is run from the seperate {@link paulscode.sound.StreamThread StreamThread}.
     *
