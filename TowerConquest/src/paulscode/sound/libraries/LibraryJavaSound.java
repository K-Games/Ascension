...
public class LibraryJavaSound extends Library {
    ...
    /**
     * Used to return a current value from one of the synchronized interface methods.
     */
    ...
    /**
     * Creates a new channel of the specified type (normal or streaming). Possible values for channel type can be found in the {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} class.
     *
