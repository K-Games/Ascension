...
public class SoundSystem {
    ...
    /**
     * Creates a new non-streaming source. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for more information about Attenuation, fade distance, and rolloff factor.
     *
    ...
    /**
     * Changes a source's attenuation model. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for more information about Attenuation.
     *
     * @param sourcename Identifier for the source.
    ...
    /**
     * Changes a source's fade distance or rolloff factor. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for more information about fade distance and rolloff.
     *
     * @param sourcename Identifier for the source.
    ...
    /**
     * Changes the Doppler factor, for determining Doppler effect scale. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for more information about Doppler effect.
     *
    ...
    /**
     * Changes the Doppler velocity, for use in Doppler effect. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for more information about Doppler effect.
     *
    ...
    /**
     * Sets the specified source's velocity, for use in Doppler effect. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for more information about Doppler effect.
     *
     * @param sourcename The source's name.
    ...
    /**
     * Sets the listener's velocity, for use in Doppler effect. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for more information about Doppler effect.
     *
     * @param x Velocity along world x-axis.
     * @param y Velocity along world y-axis.
     * @param z Velocity along world z-axis.
     ...
     * @return True if switch was successful. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for information about chosing a sound library.
     */
    public boolean switchLibrary(Class libraryClass)
        ...
        synchronized (SoundSystemConfig.THREAD_SYNC) {
            ...
            } catch (InstantiationException | IllegalAccessException | ExceptionInInitializerError | SecurityException ie) {
    ...
    /**
     * Calls the library's initialize() method. This method is used internally by SoundSystem for thread synchronization, and it can not be called directly.
     */
    ...
    /**
     * Loads a sound file into memory. This method is used internally by SoundSystem for thread synchronization, and it can not be called directly - please use the newSource() method instead.
     *
     * @param priority Setting this to true will prevent other sounds from overriding this one.
    ...
    /**
     * Opens a direct line for streaming audio data. This method is used internally by SoundSystem, and it can not be called directly - please use the rawDataStream() method instead.
     *
     * @param audioFormat Format that the data will be in.
     * @param priority Setting this to true will prevent other sounds from overriding this one.
     * @param sourcename A unique identifier for this source. Two sources may not use the same sourcename.
    ...
    /**
     * Plays the specified source. This method is used internally by SoundSystem for thread synchronization, and it can not be called directly - please use the play() method instead.
     *
     * @param sourcename Identifier for the source.
     */
    ...
    /**
     * Pauses the specified source. This method is used internally by SoundSystem for thread synchronization, and it can not be called directly - please use the pause() method instead.
     *
     * @param sourcename Identifier for the source.
     */
    ...
    /**
     * Stops the specified source. This method is used internally by SoundSystem for thread synchronization, and it can not be called directly - please use the stop() method instead.
     *
     * @param sourcename Identifier for the source.
     */
    ...
    /**
     * Rewinds the specified source. This method is used internally by SoundSystem for thread synchronization, and it can not be called directly - please use the rewind() method instead.
     *
     * @param sourcename Identifier for the source.
     */
    ...
    protected void ManageSources() {
        ...
        /**
         * *****
         * synchronized( SoundSystemConfig.THREAD_SYNC ) { // TODO: Sort the sources, cull and activate, etc. } ******
         */
    }
    ...
    /**
     * Copies and returns the peripheral information from a map of sources. This method is used internally by SoundSystem, and it is unlikely that the user will ever need to use it.
     *
    ...
    /**
     * Sets or returns the error code for the last error that occurred. If no errors have occurred, returns SoundSystem.ERROR_NONE
     *
     * @param action Action to perform (GET or SET).
