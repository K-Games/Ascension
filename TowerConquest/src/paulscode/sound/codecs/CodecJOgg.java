...
public class CodecJOgg implements ICodec {
    ...
    /**
     * Reads in one stream buffer worth of audio data. See {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} for more information about accessing and changing default settings.
     *
    ...
    private class OggInputStream extends InputStream {
        ...
        /**
         * Implements the InputStream.read() method. Reads the next byte of data from the input stream.
         *
        ...
        /**
         * Overrides the InputStream.read( byte[] ) method. Reads some number of bytes from the input stream and stores them into the buffer array.
         *
        ...
        /**
         * Overrides the InputStream.read( byte[], int, int ) method. Reads up to length bytes of data from the input stream into an array of bytes.
         *
         * @param buffer Where to put the read-in data.
