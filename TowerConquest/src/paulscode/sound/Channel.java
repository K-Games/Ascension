...
public class Channel {
    ...
    /**
     * Global identifier for the type of channel (normal or streaming). Possible values for this varriable can be found in the {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} class.
     */
    ...
    /**
     * Constructor: Takes channelType identifier as a paramater. Possible values for channel type can be found in the {@link paulscode.sound.SoundSystemConfig SoundSystemConfig} class.
     *
