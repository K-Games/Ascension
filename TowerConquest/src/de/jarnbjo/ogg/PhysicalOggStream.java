...
public interface PhysicalOggStream {
    ...
    /**
     * Returns a collection of objects implementing <code>LogicalOggStream</code> for accessing the separate logical streams within this physical Ogg stream.
     *
     * @return a collection of objects implementing <code>LogicalOggStream</code> which are representing the logical streams contained within this physical stream
     *
     ...
     *
     * @return <code>true</code> if this stream is open for reading, <code>false</code> otherwise
     */
    ...
    /**
     * @return <code>true</code> if the stream is seekable, <code>false</code> otherwise
     */
