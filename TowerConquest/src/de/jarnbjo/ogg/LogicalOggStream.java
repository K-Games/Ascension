...
public interface LogicalOggStream {
    ...
    /**
     * <i>Note:</i> To read from the stream, you must use either this method or the method <code>getNextOggPacket</code>. Mixing calls to the two methods will cause data corruption.
     *
    ...
    /**
     * <i>Note:</i> To read from the stream, you must use either this method or the method <code>getNextOggPage</code>. Mixing calls to the two methods will cause data corruption.
     *
