...
public interface BitInputStream {
     ...
     *
     * @return <code>true</code> if the next bit is 1, <code>false</code> otherwise
     *
    ...
    /**
     * reads a huffman codeword based on the <code>root</code> parameter and returns the decoded value
     *
    ...
    /**
     * fills the array from <code>offset</code> with <code>len</code> integers encoded as "signed rice" as described in the FLAC audio format specification
     *
     * @param order
     * @param buffer
     * @param offset
