...
public class SkillShieldMagnetizeTest {
    ...
    private static final Skill INSTANCE = new SkillShieldMagnetize(null);
    ...
    public void testCastPlayerState() {
        byte expResult = Player.PLAYER_STATE_SHIELD_MAGNETIZE;
