...
public class SkillPassiveKeenEyeTest {

    private static final byte SKILL_CODE = Globals.PASSIVE_KEENEYE;
    ...
    private static final Skill INSTANCE = new SkillPassiveKeenEye(null);
