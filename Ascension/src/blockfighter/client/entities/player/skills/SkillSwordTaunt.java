...
public class SkillSwordTaunt extends Skill {
    ...
    public void updateDesc() {
        ...
        this.maxBonusDesc = new String[]{
            "Take " + Globals.NUMBER_FORMAT.format(CUSTOM_VALUES.get(CUSTOM_DATA_HEADERS[2]) * 100) + "% less damage for " + Globals.TIME_NUMBER_FORMAT.format(CUSTOM_VALUES.get(CUSTOM_DATA_HEADERS[0]) / 1000) + " seconds.",
            "Deal  " + Globals.NUMBER_FORMAT.format(CUSTOM_VALUES.get(CUSTOM_DATA_HEADERS[1]) * 100) + "% increased damage for " + Globals.TIME_NUMBER_FORMAT.format(CUSTOM_VALUES.get(CUSTOM_DATA_HEADERS[0]) / 1000) + " seconds.",
            HYPER_STANCE_DESC
        };
    }
