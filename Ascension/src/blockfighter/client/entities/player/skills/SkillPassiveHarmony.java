...
public class SkillPassiveHarmony extends Skill {
    ...
    private static final byte SKILL_CODE = Globals.PASSIVE_HARMONY;
    ...
    public void updateDesc() {
        this.skillCurLevelDesc = new String[]{
            "Gain " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * this.level) * 100) + "% of Max HP as bonus damage."
        };
        this.skillNextLevelDesc = new String[]{
            "Gain " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * (this.level + 1)) * 100) + "% of Max HP as bonus damage."
        };
    }
