...
public class SkillPassiveWillpower extends Skill {
    ...
    public void updateDesc() {
        ...
        this.skillCurLevelDesc = new String[]{
            "Increase damage dealt up to " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * this.level) * 100) + "%."
        };
        this.skillNextLevelDesc = new String[]{
            "Increase damage dealt up to " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * (this.level + 1)) * 100) + "%."
        };
    }
