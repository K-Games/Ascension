...
public class SkillPassiveStatic extends Skill {
    ...
    public void updateDesc() {
        this.skillCurLevelDesc = new String[]{
            "20% Chance to shock a nearby enemy for " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * this.level) * 100) + "% of Armour as damage."
        };
        this.skillNextLevelDesc = new String[]{
            "20% Chance to shock a nearby enemy for " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * (this.level + 1)) * 100) + "% of Armour as damage."
        };
    }
