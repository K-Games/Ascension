...
public class SkillPassiveBarrier extends Skill {
    ...
    public void updateDesc() {
        this.skillCurLevelDesc = new String[]{
            "Absorbs up to " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * this.level) * 100) + "% of Max HP."
        };
        this.skillNextLevelDesc = new String[]{
            "Absorbs up to " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * (this.level + 1)) * 100) + "% of Max HP."
        };
    }
