...
public class SkillPassiveTough extends Skill {
    ...
    public void updateDesc() {
        this.skillCurLevelDesc = new String[]{
            "Take " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * this.level) * 100) + "% reduced damage."
        };
        this.skillNextLevelDesc = new String[]{
            "Take " + Globals.NUMBER_FORMAT.format((BASE_VALUE + MULT_VALUE * (this.level + 1)) * 100) + "% reduced damage."
        };
    }
