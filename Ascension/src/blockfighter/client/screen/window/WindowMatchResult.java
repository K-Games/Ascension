...
public class WindowMatchResult extends Window {
    ...
    public void draw(Graphics2D g) {
        ...
        try {
            ...
            g.drawString(MATCH_COMPLETION_REWARDS_TEXT, (int) (RESULT_BOARD.getMinX() + 15), (int) (RESULT_BOARD.getMinY() + 70));
            g.drawString(victoryStatus.getBonusesText(), (int) (RESULT_BOARD.getCenterX() - g.getFontMetrics().stringWidth(victoryStatus.getBonusesText()) / 2), (int) (RESULT_BOARD.getMinY() + 95));
