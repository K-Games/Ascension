...
public class HubClient implements Runnable {
    ...
    public static void connect() {
        ...
        try {
            ...
            Globals.log(HubClient.class, "Connected to Hub Server " + Globals.HUB_SERVER_ADDRESS, Globals.LOG_TYPE_DATA, true);
    ...
    public void run() {
        if (client == null || !client.isConnected()) {
            Globals.log(HubClient.class, "Connecting to Hub Server " + Globals.HUB_SERVER_ADDRESS, Globals.LOG_TYPE_DATA, true);
            connect();
        }
    }
