...
public class SkillBowStormPassive1 extends SkillPassive {

    public static final byte SKILL_CODE = Globals.BOW_STORM_PASSIVE1;
    ...
    public SkillBowStormPassive1(final LogicModule l) {
        super(l);
    }
