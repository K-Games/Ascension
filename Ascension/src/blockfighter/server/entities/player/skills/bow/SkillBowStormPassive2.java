...
public class SkillBowStormPassive2 extends SkillPassive {

    public static final byte SKILL_CODE = Globals.BOW_STORM_PASSIVE2;
    ...
    public SkillBowStormPassive2(final LogicModule l) {
        super(l);
    }
