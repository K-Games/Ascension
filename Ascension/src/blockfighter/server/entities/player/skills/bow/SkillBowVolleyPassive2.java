...
public class SkillBowVolleyPassive2 extends SkillPassive {

    public static final byte SKILL_CODE = Globals.BOW_VOLLEY_PASSIVE2;
    ...
    public SkillBowVolleyPassive2(final LogicModule l) {
        super(l);
    }
