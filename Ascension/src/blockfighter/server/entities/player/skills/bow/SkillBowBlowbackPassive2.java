...
public class SkillBowBlowbackPassive2 extends SkillPassive {

    public static final byte SKILL_CODE = Globals.BOW_BLOWBACK_PASSIVE2;
    ...
    public SkillBowBlowbackPassive2(final LogicModule l) {
        super(l);
    }
