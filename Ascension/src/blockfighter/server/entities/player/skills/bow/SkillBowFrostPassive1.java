...
public class SkillBowFrostPassive1 extends SkillPassive {

    public static final byte SKILL_CODE = Globals.BOW_FROST_PASSIVE1;
    ...
    public SkillBowFrostPassive1(final LogicModule l) {
        super(l);
    }
