...
public class SkillSwordCinderPassive1 extends SkillPassive {

    public static final byte SKILL_CODE = Globals.SWORD_CINDER_PASSIVE1;
    ...
    public SkillSwordCinderPassive1(final LogicModule l) {
        super(l);
    }
