...
public class SkillSwordPhantomPassive2 extends SkillPassive {

    public static final byte SKILL_CODE = Globals.SWORD_PHANTOM_PASSIVE2;
    ...
    public SkillSwordPhantomPassive2(final LogicModule l) {
        super(l);
    }
