...
/**
 * Implements the standard {@code Graphics2D} functionality, but instead draws to an OpenGL canvas.
 */
public class GLGraphics2D extends Graphics2D implements Cloneable {

    /**
     * The parent graphics object, if we have one. This reference is used to pass control back to the parent.
     */
   ...
   * The following are specific drawing helpers used explicitly.
    ...
    /**
     * The current clip rectangle. This implementation supports only rectangular clip areas. This clip must be treated as immutable and replaced but never changed.
     */
    ...
    /**
     * Sets up the graphics object in preparation for drawing. Initialization such as getting the viewport
     */
