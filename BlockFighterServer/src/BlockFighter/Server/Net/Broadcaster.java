...
/**
 * The server broadcaster. Sends data to players. Only one is created on the server.
 * @author Ken
 */
public class Broadcaster {
     ...
     */
    public void resetByte() { bytesSent = 0; }

    /**
     * Return number of bytes sent so far
     * @return Number of bytes sent
     */
    public int getBytes() { return bytesSent; }
    
    /**
     * Create a broadcaster to send bytes to connected players.
     * Server should only have one broadcaster.
     * The broadcaster should always be referenced after construction
     * and never initialized again.
     * @param logic
     */
